...
public class GameLogic {
    ...
    public void compareCards() {
           ...
           sysvalue=55;
           syskey=9024;
           cardid=9025;  Remove comments brackets to test with defined variables */
        if (cardvalue > sysvalue) { //card value selceted by user is bigger than system
            userplayer.put(syskey, sysvalue);
            System.out.println("User won System's card");
        }

        if (cardvalue < sysvalue) //value of card selected by user is smaller
        {
